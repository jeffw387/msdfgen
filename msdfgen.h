...
/// Generates a multi-channel signed distance field. Edge colors must be
/// assigned first! (see edgeColoringSimple)
void generateMSDF(
...
// Original simpler versions of the previous functions, which work well under
// normal circumstances, but cannot deal with overlapping contours.
